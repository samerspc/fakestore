  ...
  return (
    ...
    >
      ...
      <span className="text-xl font-bold text-green-500 ">${item.price}</span>
        ...
        {inCart ? 
          <button className='w-full p-1 items-center cp text-white bg-green-500 flex justify-center gap-2'
        ...
        :
          <button className='w-full p-1 items-center bg-transparent cp'
